...
# Paneb viki logo aknale ülesse vasakule
Trollicon=pygame.image.load('images/vikk1.png')
...
pygame.display.set_caption('Pacman VIKK - Rovan Kütt')
...
def startGame():
  ...
  Pacman = Player( w, p_h, "images/ithink.png" )
  ...
  while done == False:
      ...
      for event in pygame.event.get():
          ...
          if event.type == pygame.KEYDOWN:
              if event.key == pygame.K_w:
                  print("h")
                  text1 = font.render("WHY U CHEAT MAN?", True, red)
                  screen.blit(text1, [200, 200])

      # Kõik mängu loogika, kuidas nad liikuma hakkavad jne
