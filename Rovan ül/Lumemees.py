...
screen.fill([245, 245, 245], (0, 242, screen.get_width(), screen.get_height()))  # Teeb akna maa osa valgeks ehk lumeks
...
pygame.draw.circle(screen, [0, 0, 0], [151, 145], 5, 0) # nööp
pygame.draw.circle(screen, [0, 0, 0], [151, 160], 5, 0) # nööp
